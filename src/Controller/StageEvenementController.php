...
class StageEvenementController extends AbstractController
{
    ...
    public function index(StageEvenementRepository $stageEvenementRepository, ImageUploaderHelper $imageUploaderHelper, DisciplineRepository $disciplineRepository): Response
    {
