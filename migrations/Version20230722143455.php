 ...
 */
final class Version20230722143455 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE discipline DROP tarif');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE discipline ADD tarif INT NOT NULL');
    }
}
